...
def train_with_mlflow():
    ...
    dagshub.init(repo_owner='prathamesh.khade20', repo_name='MLOPS_with_creating_own_random_data', mlflow=True)
    ...
    with mlflow.start_run() as run:
        ...
        mlflow.log_param('repo_owner', 'prathamesh.khade20')
        mlflow.log_param('repo_name', 'MLOPS_with_creating_own_random_data')
        ...
        # Tags 
        mlflow.set_tag('Model developer', 'Prathamesh_khade')
